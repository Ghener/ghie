    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
          <a href="views/edits.php?id=<?= $student->ID; ?>" class="btn btn-primary mr-2" style="margin-right: 10px">Update</a>
          <a onclick="return confirm('Press confirm if you really want to delete and cancel if not')" href="database/delete.php?id=<?= $student->ID; ?>" class="btn btn-danger">Delete</a>
        </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
